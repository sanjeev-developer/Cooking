...
public class DashRecycleAdapter extends RecyclerView.Adapter<DashRecycleAdapter.MyViewHolder> {

    public ArrayList<KitchenList> dishname;
    private Context context;
    int count = 0 ;

    public DashRecycleAdapter(Context contexts, ArrayList<KitchenList> dishname)
    {
